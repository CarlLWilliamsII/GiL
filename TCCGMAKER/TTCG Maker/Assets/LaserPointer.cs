...
public class LaserPointer : OVRCursor
{
    ...
    {
        Debug.Log("Set Cursor Start");
        _startPoint = start;
        Debug.Log("start point: " + start);
        _endPoint = dest;
        Debug.Log("end point: " + dest);
        _hitTarget = true;
    }

    public override void SetCursorRay(Transform t)
    {
        Debug.Log("Set Cursor Ray");
    ...
    private void LateUpdate()
    {
        ...
        SetCursorStartDest(_start, _end, new Vector3(0,0,0));
        lineRenderer.SetPosition(0, _startPoint);
        Debug.Log("_startPoint: " + _startPoint);
        if (_hitTarget)
        {
